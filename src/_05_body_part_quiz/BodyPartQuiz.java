...
int score = 0;
		...
		// -- Tell them they are wrong and who the person is
			...
			JOptionPane.showMessageDialog(null, "You are wrong. The person in the image is Arnold");
		}
		...
		if (guess.equalsIgnoreCase("Leonardo")) {
			...
			JOptionPane.showMessageDialog(null, "You are wrong. The person in the image is Leonardo");
		}
		showNextImage();
		guess = JOptionPane.showInputDialog("Who is this?");
		if (guess.equalsIgnoreCase("Morgan")) {
			...
			JOptionPane.showMessageDialog(null, "You are wrong. The person in the image is Morgan");
		}
		showNextImage();
		guess = JOptionPane.showInputDialog("Who is this?");
		if (guess.equalsIgnoreCase("Jack")) {
			...
			JOptionPane.showMessageDialog(null, "You are wrong. The person in the image is Jack");
		}
		// 9. Show them their current score
		JOptionPane.showMessageDialog(null, "Congratulation! You're final score is " + score + ".");
	}
